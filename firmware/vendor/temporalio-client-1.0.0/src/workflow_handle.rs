...
impl WorkflowHistory {
    ...
    // Xtensa LLVM cannot select the floating-point constant pool emitted by
    // Serde's generic Content deserializer. Badges do not import JSON history;
    // keep that host-only utility out of ESP-IDF builds.
